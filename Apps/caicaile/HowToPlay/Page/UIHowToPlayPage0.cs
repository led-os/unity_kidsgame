...
public class UIHowToPlayPage0 : UIHowToPlayPage, IUIWordBoardDelegate, IUIWordContentBaseDelegate
{
    ...
    void Awake()
    {
        ...
        textDetail.text = Language.main.GetString("STR_HOWTOPLAY_DETAIL0");
        LoadPrefab();
    }
    void Start()
    {
        gameLevel = index;
        infoItem = GameGuankaParse.main.GetGuankaItemInfo(gameLevel) as CaiCaiLeItemInfo;
        LayOut();
    ...
    void RunAnimate()
    {
        ...
        Vector2 pt1 = uiWordItem.transform.position;
        UILetterItem uiLetterItem = uiWordFillBox.GetSelItem();
