...
public class UIWordBoard : MonoBehaviour, IUIWordItemDelegate
{
    ...
    void InitWord(string strAnswer)
    {
        ...
        string strAllWord = UIGameCaiCaiLe.strWord3500;
    ...
    string GetStringAnswer(CaiCaiLeItemInfo info)
    {
        ...
        idx = idxTmp[rdm];
        ItemInfo infoOther = GameViewController.main.gameBase.GetGuankaItemInfo(idx);
        if (infoOther != null)
        {
            string strOther = UIGameCaiCaiLe.languageGame.GetString(infoOther.id);
