...
public class ShapeTrail : UIView
{
    ...
    void Awake()
    {
        ...
        mesh.name = "ShapeTrail";
        // Debug.Log("setDrawTriangles");
        listPoint = new List<Vector3>();
        //setDrawTriangles();
        lineWidth = 0.5f;//0.5f
        Renderer render = GetComponent<Renderer>();
        render.material = new Material(Shader.Find("Custom/ShapeTrail"));
    }
    ...
    public void AddPoint(Vector3 vec)
    {
        ...
        vec.z = 0;
        listPoint.Add(vec);
        Debug.Log("AddPoint:listPoint=" + listPoint.Count);
