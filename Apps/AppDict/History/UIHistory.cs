...
public class UIHistory : UIView, ITableViewDataSource
{
    ...
    void LoadPrefab()
    {
        ...
        {
            GameObject obj = PrefabCache.main.Load("App/Prefab/History/UIHistoryCellItem");
    ...
    void UpdateTitle()
    {
        // string str = Language.main.GetString("STR_HISTORY");
        // textTitle.text = str;
    ...
    void UpdateList()
    {
        List<IdiomItemInfo> ls = DBHistory.main.GetAllItem();
        listItem.Clear();
        ...
        textDetail.gameObject.SetActive(DBHistory.main.DBEmpty());
        btnDeleteAll.gameObject.SetActive(!DBHistory.main.DBEmpty());
        Debug.Log("UpdateList totalItem=" + totalItem + " numRows=" + numRows + " oneCellNum=" + oneCellNum);
    ...
    public void OnCellItemDidClickDelete(UIHistoryCellItem ui)
    {
        IdiomItemInfo info = listItem[ui.index] as IdiomItemInfo;
        if (info != null)
        {
            DBHistory.main.DeleteItem(info);
        }
        UpdateList();
    }
    ...
    public TableViewCell GetCellForRowInTableView(TableView tableView, int row)
    {
        ...
        if (cell == null)
        {
            ...
            for (int i = 0; i < oneCellNum; i++)
            {
                ...
                UIHistoryCellItem loveitem = item as UIHistoryCellItem;
        ...
        {
            UIHistoryCellItem ui = it_base as UIHistoryCellItem;
