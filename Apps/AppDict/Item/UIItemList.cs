...
public class UIItemList : UIView, ITableViewDataSource
{
    ...
    void LoadPrefab()
    {
        ...
        {
            GameObject obj = PrefabCache.main.Load("AppCommon/Prefab/Item/UIItemListCellItem");
    ...
    public void OnCellItemDidClick(UICellItemBase item)
    {
        ...
        PopUpManager.main.Show<UIItemDetail>("AppCommon/Prefab/Item/UIItemDetail", popup =>
           {
