...
public class UIGameShapeColor : UIGameBase, IGameShapeColorDelegate
{
    ...
    public override void UpdateGuankaLevel(int level)
    {
        ...
        gameShapeColor.listShape = GameGuankaParse.main.listShape;
        gameShapeColor.listColor = GameGuankaParse.main.listColor;
    ...
    void LoadBg()
    {
        ...
        foreach (ShapeColorItemInfo infobg in GameGuankaParse.main.listBg)
        {
