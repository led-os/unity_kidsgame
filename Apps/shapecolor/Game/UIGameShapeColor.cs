...
public class UIGameShapeColor : UIGameBase, IGameShapeColorDelegate
{
    ...
    public override int ParseGuanka()
    {
        ...
        //  ParseShape();
        {
            ...
            if (Common.appKeyName != AppType.SHAPECOLOR)
            {
                idx = GameManager.placeLevel;
            }
            string filepath = Common.GAME_RES_DIR + "/guanka/shape_list_place" + idx + ".json";
    ...
    void OnUIViewAlertFinished(UIViewAlert alert, bool isYes)
    {
        ...
        if (STR_KEYNAME_VIEWALERT_GAME_BOMB == alert.keyName)
        {
            ...
            {
                //show ad video
                AdKitCommon.main.callbacAdVideokFinish = OnAdKitFinishAdVideo;
