...
public class UILearnProgressCellItem : UICellItemBase
{
    ...
    void Awake()
    {
        ...
        indexShape = Random.Range(0, GameGuankaParse.main.listShape.Count);
            ...
            case ITEM_TYPE_SHAPE:
                {
                    ...
                    string str = UILearnProgress.languageGame.GetString(key);
                    textTitle.text = str;
            ...
            case ITEM_TYPE_COLOR:
                {
                    ...
                    indexShape = GameGuankaParse.main.listShape.Count / 2;
                    ShapeColorItemInfo infoshape = GameGuankaParse.main.listShape[indexShape] as ShapeColorItemInfo;
