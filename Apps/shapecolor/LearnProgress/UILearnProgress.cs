...
public class UILearnProgress : UIView, ITableViewDataSource, ISegmentDelegate
{
    ...
    static List<object> listItemAll;
    ...
    void Awake()
    {
        ...
        indexSegment = GameManager.placeLevel;

        if (listItemAll == null)
        {
            listItemAll = GameManager.main.GetGuankaListOfPlace(indexSegment);
        }
    ...
    void UpdateList(int type)
    {
        ...
        {
            listItem = listItemAll;//UIGameShapeColor.listShape;
        }
        if (type == UILearnProgressCellItem.ITEM_TYPE_COLOR)
        {
            listItem = GameGuankaParse.main.listColor;
        }
    ...
    void UpdateLanguage()
    {
         ItemInfo infoPlace = GameManager.main.GetPlaceItemInfo(indexSegment);
    ...
    public void ParserSortList()
    {
        ...
        {
            ItemInfo infoPlace = GameManager.main.GetPlaceItemInfo(i);
            if (uiSegment != null)
            {
    ...
    public void UpdateSortList(int idx)
    {
        ...
        listItemAll = GameManager.main.GetGuankaListOfPlace(idx);
        UpdateLanguage();
        UpdateList(itemType);
