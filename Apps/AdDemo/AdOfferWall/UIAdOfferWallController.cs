...
using Moonma.AdKit.AdOfferWall;


public class UIAdOfferWallController : UIView, ITableViewDataSource
{
    ...
    void LoadPrefab()
    {
        ...
        {
            GameObject obj = PrefabCache.main.Load("AppCommon/Prefab/AdOfferWall/UIAdOfferWallCellItem");
    ...
    public void OnCellItemDidClick(UICellItemBase item)
    {
        ...
        AdOfferWall.InitAd(info.source);
        AdOfferWall.ShowAd();
