...
public class AppRes
{
    ...
    public const string AUDIO_DragFail = "AppCommon/Audio/DragFail";
    public const string AUDIO_DragOk = "AppCommon/Audio/DragOk";
    public const string AUDIO_GuankaOk = "AppCommon/Audio/GuankaOk";
