...
public class UIAdInsertController : UIView, ITableViewDataSource
{
    ...
    void LoadPrefab()
    {
        ...
        {
            GameObject obj = PrefabCache.main.Load("AppCommon/Prefab/AdInsert/UIAdInsertCellItem");
