...
public class UIAdBannerController : UIView, ITableViewDataSource
{
    ...
    void LoadPrefab()
    {
        ...
        {
            GameObject obj = PrefabCache.main.Load("AppCommon/Prefab/AdBanner/UIAdBannerCellItem");
    ...
    public void OnCellItemDidClick(UICellItemBase item)
    {
        ...
        UIGameAdDemo.strSourceAdBanner = info.source;
