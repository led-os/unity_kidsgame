...
public class UIGamePintu : UIGameBase, IGamePintuDelegate
{
    ...
    void LoadGameTexture()
    {
        ...
        ItemInfo info = GameGuankaParse.main.GetItemInfo();
    ...
    {
        ParseGame();
        ItemInfo info = GameGuankaParse.main.GetGuankaItemInfo(lv);
        return info.pic;
    }
    ...
    void DoConvertImage()
    {
        ...
        if (saveImageIndex < GameGuankaParse.main.listGuanka.Count)
        {

            ItemInfo info = GameGuankaParse.main.GetGuankaItemInfo(saveImageIndex);
            ConvertImage(info);
            // {
