    ...
    public void ShowItemAnimate()
    {
        ...
        //left or top
        {
            if (Device.isLandscape)
            {
                ...
                h = mainCam.orthographicSize * 2 - GameManager.main.heightAdWorld - heightTopbarWorld;
                y = -mainCam.orthographicSize;
                y += GameManager.main.heightAdWorld;
            }
            else
            {
                //top
        ...
        //right or bottom
        {
            ...
            else
            {
                ...
                w = Common.GetCameraWorldSizeWidth(mainCam) * 2;
                x = -Common.GetCameraWorldSizeWidth(mainCam);
                y = -mainCam.orthographicSize + GameManager.main.heightAdWorld;
