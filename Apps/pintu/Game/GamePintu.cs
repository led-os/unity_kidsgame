...
public class GamePintu : GameBase, IUIPintuBlockDelegate
{
    ...
    public int heightAdBanner;
    public float heightAdBannerWorld;
    ...
    void Awake()
    {
        ...
        if (heightAdBanner == 0)
        {
            heightAdBanner = (int)(128 * AppCommon.scaleBase);
    ...
    void UpdateGameImage(Texture2D tex, bool isOption)
    {
        ...
        // if (objGamePic == null)
        {
            ...
            Sprite sprite = LoadTexture.CreateSprieFromTex(tex);
            sprite.name = "game";
            spRd.sprite = sprite;
    ...
    public void ShowItemAnimate()
    {
        ...
        //left or top
        {
            if (Device.isLandscape)
            {
                ...
                h = mainCam.orthographicSize * 2 - heightAdBannerWorld - heightTopbarWorld;
                y = -mainCam.orthographicSize;
                y += heightAdBannerWorld;
            }
            else
            {
                //top
            ...
            for (int i = 0; i < listItemLeft.Count; i++)
            {
                ...
                Vector2 pos = layoutLeft.GetItemPostion(row, col);
        ...
        //right or bottom
        {
            ...
            else
            {
                ...
                w = Common.GetCameraWorldSizeWidth(mainCam) * 2;
                x = -Common.GetCameraWorldSizeWidth(mainCam);
                y = -mainCam.orthographicSize + heightAdBannerWorld;
            ...
            for (int i = 0; i < listItemRight.Count; i++)
            {
                ...
                Vector2 pos = layoutRight.GetItemPostion(row, col);
