...
public class UIToolBar : UIView
{
    ...
    {
        if (UIGameXieHanzi.gameMode == UIGameXieHanzi.GAME_MODE_FREE_WRITE)
        {
    ...
    {
        indexBihua = 0;
        uiGameXieHanzi.GotoWordWriteMode(WordWriteMode.WriteWithOneWord);
    }
    public void OnClickBtnBihuaOne()
    {
        indexBihua = 0;
        uiGameXieHanzi.GotoWordWriteMode(WordWriteMode.WriteWithOneBihua);
    }
    public void OnClickBtnBihuaNone()
    {
        indexBihua = 0;
        uiGameXieHanzi.GotoWordWriteMode(WordWriteMode.WriteWithNone);
    ...
    void DoBtnSave()
    {
        WordItemInfo info = uiGameXieHanzi.GetItemInfo();
