...
public class AppXieHanzi
{
    ...
    //image 
    public const string RES_WORDWRITE_MODE_ALL_UNSEL = "App/Game/hanziyuan/common/btnMode1_y";
    public const string RES_WORDWRITE_MODE_ALL_SEL = "App/Game/hanziyuan/common/btnMode1";

    public const string RES_WORDWRITE_MODE_ONE_UNSEL = "App/Game/hanziyuan/common/btnMode2_y";
    public const string RES_WORDWRITE_MODE_ONE_SEL = "App/Game/hanziyuan/common/btnMode2";

    public const string RES_WORDWRITE_MODE_NONE_UNSEL = "App/Game/hanziyuan/common/btnMode3_y";
    public const string RES_WORDWRITE_MODE_NONE_SEL = "App/Game/hanziyuan/common/btnMode3";
