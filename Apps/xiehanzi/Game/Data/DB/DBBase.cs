...
public class DBBase
{
    ...
    public virtual void AddItem(DBWordItemInfo info)
    {
        OpenDB();
        int lengh = colLength;
    ...
    public virtual void ReadInfo(DBWordItemInfo info, SqlInfo infosql)
    {
    ...
    public List<DBWordItemInfo> GetAllItem()
    {
        // Distinct 去掉重复
        //desc 降序 asc 升序 
