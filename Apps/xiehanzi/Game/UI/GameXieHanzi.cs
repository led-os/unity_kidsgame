...
public class GameXieHanzi : UIView
{
    ...
    {
        gameMode = GameManager.main.gameMode;
    ...
    {
        {
            GameObject obj = (GameObject)Resources.Load("AppCommon/Prefab/Game/PaintLine");
            if (obj != null)
            {
        ...
        {
            GameObject obj = PrefabCache.main.Load("AppCommon/Prefab/Game/WordWrite2");
    ...
    void ShowGameWin()
    {
        ...
        DBWord.main.AddItem(info.dbInfo);
        ...
        controller.ui.gameLevelNow = LevelManager.main.gameLevel;
        controller.ui.UpdateItem(GameLevelParse.main.GetItemInfo());
        Debug.Log("ShowGameWin end");

    }

   static public string GetSavePath(WordItemInfo info)
    { 
    ...
    void CaptureWordWrite()
    {
        ...
        string filepath = GetSavePath(info);
