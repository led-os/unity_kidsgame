...
public class GameFillColor : UIView
{
    ...
    void LayoutMainPaint()
    {
        ...
        if (texPic)
        {
            ...
            float scaley = (world_size.y - topbar_h_world - adbar_h_world - oft_top - oft_bottom) / h_tex;
...
*/
    ...
    void onTouchDown()
    {
        ...
        Vector3 posTouchWorld = mainCam.ScreenToWorldPoint(inputPos);
        ptDown = inputPos;
        ptDownWorld = meshTex.transform.position;
    ...
    void onTouchMove()
    {
        ...
        Vector3 pos = meshTex.transform.position;
        ...
        if (isHaveTouchMove)
        {
            ...
            {
                float z = pos.z;
                meshTex.transform.position = new Vector3(x, y, z);
    ...
    void onMultiTouchMove()
    {
        ...
        float scale = 0;
        float z = meshTex.transform.position.z;
        if (scaleGamePic > scaleGamePicNormal)
        {
            scale = scaleGamePic;
        ...
        else
        {
            ...
            meshTex.transform.position = new Vector3(0, 0, z - 1);
        }
        ...
        z = meshTex.transform.position.z;
        meshTex.transform.position = new Vector3(x, y, z);
